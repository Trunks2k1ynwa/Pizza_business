...
const HomeContact = () => {
  return (
    <section className="text-white lg:flex-row bg-cover bg-[url('https://images.unsplash.com/photo-1473773508845-188df298d2d1?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1374&q=80')] flex-col gap-6 justify-center  flex gap-x-[17rem] px-[4rem] center-cross py-[4rem] bg-center">
